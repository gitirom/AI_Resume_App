...
CREATE TABLE skills (
    ...
    INDEX idx_category (category)       -- Creates an index on the category column => Makes searches faster when filtering by category:
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;   -- allows storing all characters (including emojis 😊)
...
-- Insert default admin (password: admin2002)
INSERT INTO admin_users (username, password_hash, email)
VALUES ('admin', SHA2('admin2002', 256), 'admin@resumeanalyzer.com')